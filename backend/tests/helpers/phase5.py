    ...
    await admin_conn.execute("""
        INSERT INTO tenant_pos_connections (
            ...
            prev_refresh_token_enc, refresh_failure_count, state
                  ...
                  $4,$5,$6,$7,$8,$9,$10)
    """,
        cid, seed["tenant_id"], mid,
        enc.encrypt("original_access"), access_exp,
        enc.encrypt("original_refresh"), refresh_exp,
        None, failure_count, state,
    )
